...
const CoOpportunityParticipants = () => {
  ...
  const fetchParticipantCount = async () => {
    try {
      ...
      const response = await axios.get(
        `${API_BASE_URL}/opportunities/${opportunityId}/participants/count`, // Adjust the endpoint as needed
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export default CoOpportunityParticipants;
